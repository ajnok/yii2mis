...
abstract class BaseMigrateController extends Controller
{
    ...
    public function actionCreate($name)
    {
        ...
        $file = $this->migrationPath . DIRECTORY_SEPARATOR . $name . 'info.php';
    ...
    {
        $file = $this->migrationPath . DIRECTORY_SEPARATOR . $class . 'info.php';
        require_once($file);
    ...
    protected function getNewMigrations()
    {
        ...
        while (($file = readdir($handle)) !== false) {
            ...
            if (preg_match('/^(m(\d{6}_\d{6})_.*?)\info.php$/', $file, $matches) && !isset($applied[$matches[2]]) && is_file($path)) {
