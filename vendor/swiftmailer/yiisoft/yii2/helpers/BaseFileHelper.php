...
class BaseFileHelper
{
     ...
     *   For example, 'info.php' matches all file paths ending with 'info.php'.
     ...
     *   For example, "views/*info.php" matches "views/index.php" but not "views/controller/index.php".
     *   A leading slash matches the beginning of the pathname. For example, "/*info.php" matches "index.php" but not "views/start/index.php".
